...
root: "/Users/alpun/Desktop/Bimodality/"
---
...
```
```{r}
install.packages(c("impute", "GEOquery"))
install.packages('BiocManager')
install.packages("knitr")
BiocManager::install("Biobase", site_repository = "https://cran.rstudio.com/")
...
mRNA_function <- function(eset.collapsed){
...
main_function <- function(APC_RMA_txt, Apc_p21_txt, pdata_txt, Apc_prots_txt, petal_networks_txt){
  ...
  mRNA <- mRNA_function(eset.collapsed)
